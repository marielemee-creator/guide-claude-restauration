...
- 40 fiches pratiques réparties en neuf catégories ;
- recherche conversationnelle locale par mots-clés ;
- filtres Claude, Claude Code et mise en place rapide ;
- méthode, prompt de départ et point de vigilance pour chaque cas ;
- interface responsive et utilisable au clavier ;
- aucune API, aucun compte et aucune donnée réelle.

La zone conversationnelle est volontairement simulée dans le navigateur. Elle oriente vers les fiches sans envoyer de contenu à un service externe.
